...
def collect_camera_poses_for_dataset_retrain(dataset: Optional[InputDataset]) -> List[Dict[str, Any]]:
    """Collects rescaled, translated and optimised camera poses for a dataset.
...
def collect_camera_poses_retrain(pipeline: VanillaPipeline) -> Tuple[List[Dict[str, Any]], List[Dict[str, Any]]]:
    """Collects camera poses for train and eval datasets.
    ...
    train_frames = collect_camera_poses_for_dataset_retrain(train_dataset)
    eval_frames = collect_camera_poses_for_dataset_retrain(eval_dataset)
